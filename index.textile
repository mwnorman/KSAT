...
Java runtime (I recommend "Java 6":http://java.sun.com/javase/6 since Java 5 is "end-of-life'd":http://java.sun.com/products/archive/eol.policy.html
...
<p><a href="http://www.opensource.org/licenses/isc-license.txt">ISCL ('new' BSD-style license)</a>
  ...
  <ul class="posts">
    {% for post in site.posts limit:5 %}
      <li>
        <a href="{{site.base_dir}}{{ post.url }}">{{ post.title }}</a>&nbsp;&nbsp;<em>Posted on {{ post.date | date_to_long_string }}.</em>
      </li>
    {% endfor %}
  </ul>
</div>