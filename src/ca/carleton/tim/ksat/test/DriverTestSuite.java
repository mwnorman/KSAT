...
public class DriverTestSuite {
	...
	public void test2() {
		...
		driver.setDriverClass("org.apache.derby.jdbc.AutoloadedDriver");
	...
	public void test3() {
		...
		driver.setDriverClass("oracle.jdbc.OracleDriver");
		assertTrue(driver.isOk());
	}
	...
	public void test4() {
		...
		driver.setDriverClass("com.microsoft.jdbc.sqlserver.SQLServerDriver");
		assertTrue(driver.isOk());
	}
