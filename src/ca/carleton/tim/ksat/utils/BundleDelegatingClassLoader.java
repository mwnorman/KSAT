 ...
 * @author Costin Leau
 * 
 * modified by mwnorman - remove some Spring/Apache components; basic functionality remains
 */
public class BundleDelegatingClassLoader extends ClassLoader {
	
	protected ClassLoader bridge;
	protected Bundle backingBundle;
	...
	public static BundleDelegatingClassLoader createBundleClassLoaderFor(final Bundle bundle,
		...
		return AccessController.<BundleDelegatingClassLoader>doPrivileged(
			new PrivilegedAction<BundleDelegatingClassLoader>() {
	...
	public String toString() {
		return "BundleDelegatingClassLoader for [" + 
			OsgiStringUtils.nullSafeNameAndSymName(backingBundle) + "]";
	}
