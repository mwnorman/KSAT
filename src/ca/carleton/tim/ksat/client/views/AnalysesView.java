...
public class AnalysesView extends ViewPart {
    ...
    public TreeViewer analysesViewer;
	...
	public void setCurrentAdapter(AnalysisAdapter currentAdapter) {
    ...
    public static class KSATInvisibleRoot {
        ...
        Object parent;
        public KSATRoot[] children = new KSATRoot[1];
